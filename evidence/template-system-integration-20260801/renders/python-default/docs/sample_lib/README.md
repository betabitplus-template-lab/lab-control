---
name: sample-lib-docs
doc_type: index
description: Package documentation index for sample lib. Use when you need to navigate architecture, usage, dependency, or verification docs.
---
