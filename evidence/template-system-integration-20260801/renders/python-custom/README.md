...
- Package-specific tests under `tests/orbital_kit/`.
- Runnable public API examples under `examples/orbital_kit/`.
- Manual probes under `workbench/orbital_kit/`.
- Package docs under `docs/orbital_kit/`.
...
```python
from orbital_kit import OrbitalKitConfig, get_config, install_config
...
- Distribution name: `orbital-kit`
- Import package: `orbital_kit`
- Public API objects in `src/orbital_kit/__init__.py`
- Package docs under `docs/orbital_kit/`
- Package tests under `tests/orbital_kit/`
- Runnable examples under `examples/orbital_kit/`
- Workbench probes under `workbench/orbital_kit/`
- Project URLs in `pyproject.toml`
- Environment prefix: `ORBITAL_KIT`
- Optional `[tool.py_lib_runtime.logging]` policy if local runs need
  non-default logging levels or quiet third-party modules

## Documentation

Start with [docs/orbital_kit/README.md](docs/orbital_kit/README.md)
