# %%
"""Orbital Kit public config boundary scenario.
...
Covers:
    ...
    Interface: top-level `orbital_kit`
...
Checks:
    ...
    Examples:
        Run manually:
            uv run python -m \
                tests.orbital_kit.e2e.public_boundary.test_public_config_pipeline
