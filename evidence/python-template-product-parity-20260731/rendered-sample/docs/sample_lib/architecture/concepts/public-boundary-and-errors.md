...
description: High-level public boundary and error model for sample lib. Use when you need to understand what may leave the package boundary.
---
...
This document describes what callers should receive from sample lib
