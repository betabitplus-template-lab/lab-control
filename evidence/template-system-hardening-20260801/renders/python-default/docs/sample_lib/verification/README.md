...
name: verification
doc_type: index
description: Index of the verification-oriented docs for sample lib. Use when you need to find e2e proof docs, runnable example smoke checks, or live workbench validation docs.
---
...
These docs describe the main verification layers around sample lib:
