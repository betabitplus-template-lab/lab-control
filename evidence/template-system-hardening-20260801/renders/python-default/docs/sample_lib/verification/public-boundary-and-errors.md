...
[test_public_package.py](../../../tests/sample_lib/unit/test_public_package.py):
...
[test_public_config_pipeline.py](../../../tests/sample_lib/e2e/public_boundary/test_public_config_pipeline.py):
...
`uv run pytest tests/sample_lib/e2e/public_boundary -q --no-cov`
proves the top-level public export list is present, unique, and internally
consistent.

`uv run pytest tests/sample_lib/e2e/examples`
