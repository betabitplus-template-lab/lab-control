...
description: High-level public boundary and error model for orbital kit. Use when you need to understand what may leave the package boundary.
---
...
This document describes what callers should receive from orbital kit
...
- `OrbitalKitError` is the package-specific public error base.
