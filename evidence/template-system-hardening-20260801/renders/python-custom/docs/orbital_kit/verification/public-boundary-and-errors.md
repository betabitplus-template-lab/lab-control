...
[test_public_package.py](../../../tests/orbital_kit/unit/test_public_package.py):
...
[test_public_config_pipeline.py](../../../tests/orbital_kit/e2e/public_boundary/test_public_config_pipeline.py):
...
`uv run pytest tests/orbital_kit/e2e/public_boundary -q --no-cov`
proves the top-level public export list is present, unique, and internally
consistent.

`uv run pytest tests/orbital_kit/e2e/examples`
